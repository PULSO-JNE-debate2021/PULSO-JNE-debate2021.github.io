...
segu2017=segu2017 + labs(fill="Porcentaje (%)",
                     title = "Población sin seguro de salud", subtitle = "2017")
...
segu=segu + labs(fill ="Puntos porcent.",
                 title="Población sin seguro de salud",subtitle = "Avances entre 2007- 2017")

info=base + geom_sf(aes(fill=pob_empleo_informal_cat))
info=info + labs(fill="Puntos porcent.",
                 title = "Tasa de empleo informal",subtitle = "Avances entre 2008- 2019")

analf=base + geom_sf(aes(fill=pob_analfabetismo_cat)) 
analf=analf + labs(fill="Puntos porcent.",title = "Tasa de analfabetismo",subtitle = "Avances entre 2007- 2017")

agua=base + geom_sf(aes(fill=viv_sin_agua_cat)) 
agua=agua + labs(fill="Puntos porcent.",title = "Hogares sin acceso a agua",subtitle = "Avances entre 2007- 2017")

elec=base + geom_sf(aes(fill=viv_sin_electricidad_cat)) 
elec=elec + labs(fill="Puntos porcent.",title = "Hogares sin acceso a alumbrado eléctrico",subtitle = "Avances entre 2007- 2017")

alqui=base + geom_sf(aes(fill=viv_alquilada_cat)) 
alqui=alqui + labs(fill="Puntos porcent.",title = "Viviendas alquiladas",subtitle = "Avances entre 2007- 2017")

tic=base + geom_sf(aes(fill=hog_sin_TIC_cat)) 
tic=tic + labs(fill="Puntos porcent.",title = "Hogares sin TIC",subtitle = "Avances entre 2007- 2017")

servhig=base + geom_sf(aes(fill=hog_sin_servhigie_cat)) 
servhig=servhig + labs(fill="Puntos porcent.",title = "Hogar sin servicios higiénicos",subtitle = "Avances entre 2007- 2017")
 
haci=base + geom_sf(aes(fill=hog_hacinamiento_cat)) 
haci=haci + labs(fill="Puntos porcent.",title = "Hogares en hacinamiento",subtitle = "Avances entre 2007- 2017")
...
* Avances: Es el resultado de la diferencia entre la cifra del indel 2017, o el mayor año, y la cifra del 2007, o el menor año, en puntos porcentuales. 
  ...
  + 10 a 10: La diferencia implica un retroceso intermedio de entre 1 y 10 puntos porcentuales.
